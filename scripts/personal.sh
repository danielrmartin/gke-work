...
name=partners-cje
region=us-central1
gcloud container clusters create $name --region=$region  --machine-type=n1-standard-2 --num-nodes=1  --enable-autoscaling --min-nodes 1 --max-nodes 1 --enable-basic-auth
